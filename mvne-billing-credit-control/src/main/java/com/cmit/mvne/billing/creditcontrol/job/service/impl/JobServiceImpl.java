package com.cmit.mvne.billing.creditcontrol.job.service.impl;
...
import com.cmit.mvne.billing.creditcontrol.job.mapper.JobMapper;
import com.cmit.mvne.billing.creditcontrol.job.service.IJobService;
import com.cmit.mvne.billing.creditcontrol.job.util.ScheduleUtils;
...
public class JobServiceImpl extends ServiceImpl<JobMapper, Job> implements IJobService {
    ...
    @Override
    public IPage<Job> findJobs(Pageable pageable, Job job) {
        ...
        Page<Job> page = new Page<>(pageable.getPageNumber(), pageable.getPageSize());
