...
import com.cmit.mvne.billing.creditcontrol.job.mapper.JobLogMapper;
import com.cmit.mvne.billing.creditcontrol.job.service.IJobLogService;
...
public class JobLogServiceImpl extends ServiceImpl<JobLogMapper, JobLog> implements IJobLogService {
    ...
    @Override
    public IPage<JobLog> findJobLogs(Pageable pageable, JobLog jobLog) {
        ...
        Page<JobLog> page = new Page<>(pageable.getPageNumber(), pageable.getPageSize());
