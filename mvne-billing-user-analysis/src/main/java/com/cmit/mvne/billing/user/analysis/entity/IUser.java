...
//  @JSONField(format="yyyy-MM-dd HH:mm:ss")
    ...
    public IUser(IUserDto iUserDto){
        this.orderId = iUserDto.getOrderId();
        this.userId = iUserDto.getUserId();
        this.acctId = iUserDto.getAcctId();
        this.custId = iUserDto.getCustId();
        this.msisdn = iUserDto.getMsisdn();
        this.imsi = iUserDto.getImsi();
        this.channelCode = iUserDto.getChannelCode();
        ...
        this.validDate = user_validateDate;
        this.expireDate = user_expireDate;
        this.userStatus = iUserDto.getUserStatus();
    }
/*    @Override
