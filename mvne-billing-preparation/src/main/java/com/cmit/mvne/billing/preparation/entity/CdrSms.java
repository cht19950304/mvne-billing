...
//        if(recordType.equals("RSMO") || recordType.equals("SMS")) {
//            sb.append(msisdn).append(imsi).append(numberB).append(eventTimestamp).append(callIdentification);
//        } else {
//            sb.append(msisdn).append(imsi).append(eventTimestamp).append(callIdentification);
//        }
