...
public class CdrError {
    ...
    public CdrError(Long id, String originFile, Long lineNumber, String errorCode, String status, Date receiveTime, Date createTime, Date redoTime) {
        this.id = id;
    ...
    public CdrError(Long id, String originFile, Long lineNumber, String errorCode, String status, Date receiveTime, Date createTime, Date redoTime, String cdrDetail) {
        this.id = id;
        this.originFile = originFile;
        this.lineNumber = lineNumber;
        this.errorCode = errorCode;
