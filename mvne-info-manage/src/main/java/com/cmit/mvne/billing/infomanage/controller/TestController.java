...
/*    @Autowired
    ...
    String testStr() {
        ...
        infoManageCrmEntity.setOrdOrder(iOrdOrder);
        infoManageCrmEntity.setUser(iUser);
        infoManageCrmEntity.setProd(iProd);

        return JSON.toJSONString(infoManageCrmEntity);
    }
