...
public class SettleCdrGprsError {
    private Long id;
    ...
    public SettleCdrGprsError(Long id, String recordType, String numberA, String numberB, String numberDialed, String msisdn, String imsi, String eventTimeStamp, Date localEventTimeStamp, Integer eventDuration, BigDecimal downloadVol, BigDecimal uploadVol, String operatorCode, String preratedAmount, String apn, String nulli, String broadWorks, String teleServiceCode, String bearerServiceCode, String overseasCode, String videoIndicator, String source, String serviceId, String quantity, String custNumber, String description, String callIdentification, String tailNumber, String originalFile, Long lineNumber, String invoicingPeriod, String settleItem, String errorCode, String status, Date createTime, Date receiveTime, Date redoTime, Date finishTime, String errorMessage) {
        this.id = id;
        this.recordType = recordType;
        this.numberA = numberA;
        this.numberB = numberB;
    ...
    public void setSettleItem(String settleItem) {
        this.settleItem = settleItem == null ? null : settleItem.trim();
    }
