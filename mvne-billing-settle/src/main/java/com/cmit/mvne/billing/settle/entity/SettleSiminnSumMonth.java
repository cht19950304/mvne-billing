...
public class SettleSiminnSumMonth {
    ...
    public SettleSiminnSumMonth(Long id, String invoicingPeriod, BigDecimal chargeFee, String chargeMeasure, BigDecimal totalFee, BigDecimal totalValue, String itemName, String itemMeasure, Date createTime, Date updateTime) {
        this.id = id;
